...
def main():
    ...
    result = morphology._dilation(img, False, 1, sel=np.ones((100, 1), dtype=np.int64))
    final_result = morphology._erosion(result, False, 1, sel=np.ones((100, 1), dtype=np.int64))
